                                ...
                                <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="{{ asset('resources/app-assets/images/pages/login-v2.svg') }}" class="img-fluid d-block w-100" alt="cf-img-1" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('resources/app-assets/images/slider/02.jpg') }}" class="img-fluid d-block w-100" alt="cf-img-2" />
                                        </div>
                                        <div class="carousel-item">
                                            <img src="{{ asset('resources/app-assets/images/pages/login-v2.svg') }}" class="img-fluid d-block w-100" alt="cf-img-1" />
                                        </div>
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            ...
                            <form method="POST" class="auth-login-form mt-2" action="{{ route('login') }}">
                              @csrf
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center"><a class="btn btn-facebook" href="{{ url('auth/facebook') }}"><i data-feather="facebook"></i></a><a class="btn btn-twitter white" href="{{ url('auth/twitter') }}"><i data-feather="twitter"></i></a><a class="btn btn-google" href="#"><i data-feather="mail"></i></a><a class="btn btn-github" href="#"><i data-feather="github"></i></a></div>
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
