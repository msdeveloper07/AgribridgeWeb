                    ...
                    <div class="auth-inner justify-content-end row m-0">
                        ...
                        <div class="d-flex align-items-center auth-bg">
                            <div class="col-12 mx-auto">
                                ...
                                <h2 class="card-title text-center">Login to <span>Agribridge</span></h2>
                                ...
                                <button type="submit" id="loginBtn" class="btn btn-border-warning waves-effect wavs-float- waves-light w-100" tabindex="4">

                                {{ __('Login to Agribridge') }}
                                </button>
                                </form>
